    ...
    <div class="page-shell">
        <div class="content-inner">
            ...
            <section class="section">
                <h1 class="section-title" style="margin-bottom: 0.5rem;">Dashboard</h1>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.75rem; margin-bottom: 1rem;">
                    <div class="feature-card" style="text-align: center; padding: 0.75rem;">
                        ...
                        <div style="color: var(--text-muted); font-size: 0.85rem;">Pacchetti</div>
                    </div>
                    ...
                    <div class="feature-card" style="text-align: center; padding: 0.75rem;">
                        ...
                        <div style="color: var(--text-muted); font-size: 0.85rem;">Download</div>
                    </div>
                ...
                <!-- Package List -->
                <h3 style="margin: 0 0 0.5rem; color: var(--text-secondary);">I Tuoi Pacchetti</h3>

                <?php if (empty($packages)): ?>
                    <div class="alert alert-info">
                        <span class="alert-icon">i</span>
                        <div>
                            Nessun pacchetto. <a href="create.php" style="color: var(--accent);">Crea il primo</a>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="packages-list" style="gap: 0.5rem;">
                        <?php foreach ($packages as $pkg): ?>
                            <a href="dashboard-package.php?id=<?= $pkg['uuid'] ?>" class="package-card-link" style="text-decoration: none;">
                                <div class="feature-card" style="cursor: pointer; padding: 0.75rem; transition: transform 0.2s, box-shadow 0.2s;">
                                    <div style="display: flex; justify-content: space-between; align-items: center; gap: 0.5rem;">
                                        <div style="min-width: 0; flex: 1;">
                                            <h4 style="margin: 0; color: var(--text-main); font-size: 0.95rem;"><?= e($pkg['name']) ?></h4>
                                            <div style="color: var(--text-muted); font-size: 0.8rem; display: flex; gap: 1rem; margin-top: 0.25rem;">
                                                <span><?= $pkg['total_questions'] ?> domande</span>
                                                <span><strong style="color: var(--accent);"><?= $pkg['unique_users'] ?></strong> studenti</span>
                                                <span><strong style="color: var(--accent);"><?= $pkg['total_downloads'] ?></strong> download</span>
                                            </div>
                                        </div>
